...
- **Database Creation**: The project starts by creating a database named `retail_sales_1`.
- **Table Creation**: A table named `retail_sales_1` is created to store the sales data. The table structure includes columns for transaction ID, sale date, sale time, customer ID, gender, age, product category, quantity sold, price per unit, cost of goods sold (COGS), and total sale amount.
...
SELECT DISTINCT category FROM retail_sales_1;
